$PBExportHeader$nvo_testdrag_mlsync.sru
$PBExportComments$Non-visual object that controls dbmlsync
forward
global type nvo_testdrag_mlsync from mlsync
end type
end forward
...
string logopts = ""
string port = ""
string progresswindowname = "w_testdrag_syncprogress"
string publication = "rtwr"
string logfilename = ""
string syncregistrykey = "Software\Sybase\PowerBuilder\17.0\testdrag"
// 
...
global nvo_testdrag_mlsync nvo_testdrag_mlsync

type variables
w_testdrag_syncprogress		i_syncwindow
...
on nvo_testdrag_mlsync.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_testdrag_mlsync.destroy
